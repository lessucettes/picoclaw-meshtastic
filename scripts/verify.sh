...
(
	...
	CGO_ENABLED=0 GOTOOLCHAIN="$PICOCLAW_GO_TOOLCHAIN" go test -tags=goolm,stdjson ./pkg/channels/meshtastic ./pkg/agent ./pkg/bus ./pkg/channels ./pkg/config ./pkg/gateway
